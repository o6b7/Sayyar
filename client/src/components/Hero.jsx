      ...
      <AnimatedItem>
        ...
        >
          ...
          <div className="flex items-end w-full md:w-auto">
            <button 
              type="submit"
              className="flex items-center justify-center gap-2 px-8 py-3 w-full md:w-auto mb-1 bg-primary hover:bg-primary-dull text-white rounded-lg shadow-md hover:scale-105 transition"
            >
